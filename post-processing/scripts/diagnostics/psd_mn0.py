...
def plot_power_spectrum_density(phi2D_list, time_step, filename):
	...
	frequencies, power_spectrum_density = utils.map_power_spectrum(radial_time_series, 80, time_step);
...
def main(data_arrays, time_step, filename):

	# Entry point for `diagnostics_main.py`.
	plot_power_spectrum_density(data_arrays, time_step, filename);